...
/datum/job/proc/setup_account(var/mob/living/carbon/human/H)
	...
	if(H.mind)
		var/remembered_info = ""
		remembered_info += "<b>Votre numéro de compte est :</b> #[M.account_number]<br>"
		remembered_info += "<b>Le code pin de votre compte est :</b> [M.remote_access_pin]<br>"
		remembered_info += "<b>Le montant des fonds sur votre compte est de :</b> T[M.money]<br>"
	...
	to_chat(H, "<span class='notice'><b>Votre numéro de compte est :[M.account_number], le code pin de votre compte est :[M.remote_access_pin]</b></span>")
